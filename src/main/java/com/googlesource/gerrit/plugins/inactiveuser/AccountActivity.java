...
@Singleton
public class AccountActivity implements LifecycleListener {
    ...
    private final Logger log = LoggerFactory.getLogger(AccountActivity.class);
    ...
    @Inject
    AccountActivity(SchemaFactory<ReviewDb> schemaFactory,
                    WorkQueue workQueue,
    ...
    public static final class TimestampedAccount {
